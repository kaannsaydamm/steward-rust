...
// Steward Cloud discovery lifecycle for the cloud-mode panel.
...
export function GatewaySettings({ embedded = false }: { embedded?: boolean } = {}) {
  ...
  // --- Steward Cloud (cloud mode) state ---
  ...
  return (
    <SettingsContent bare={embedded}>
      ...
      {/* Steward Cloud panel: one portal sign-in, then a discovered-agent picker
