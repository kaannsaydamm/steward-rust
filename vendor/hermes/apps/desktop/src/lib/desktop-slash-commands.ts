...
/** Why a known Steward command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Steward profile', surface: action('profile') },
  {
    name: '/skin',
 ...
 * Steward' built-in slash commands — i.e. skill commands (`/gif-search`,
 ...
 * activity — the ones that ship with Steward and were never asked for. It is
