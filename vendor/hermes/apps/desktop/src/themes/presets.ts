...
/**
 * Steward — the canonical Steward desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Steward's own: a VS Code theme carries no font opinion, and
...
/**
 * Steward — the canonical Steward desktop identity: GitHub's chrome carrying Steward
...
export const nousTheme: DesktopTheme = {
  name: 'nous',
  label: 'Steward',
  description: 'GitHub chrome, Steward blue accent',
  colors: {
    background: '#ffffff',
    foreground: '#1f2328',
    card: '#f6f8fa',
...
/**
 * Steward Alt — the hand-authored Steward from before the GitHub fork. Light is
