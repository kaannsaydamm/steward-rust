...
export const en: Translations = {
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Steward plugins (`steward plugins` parity).",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Steward doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
