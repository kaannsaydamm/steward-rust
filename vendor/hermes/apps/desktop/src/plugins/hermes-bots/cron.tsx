/**
 * Routines: the Steward cron jobs scoped to the bot you're chatting with — the
...
// Steward-native schedule string; Advanced exposes it raw.
...
/** Compose the Steward schedule string from picker state. */
