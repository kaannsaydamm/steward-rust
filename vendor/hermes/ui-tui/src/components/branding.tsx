...
const TAG_FULL = 'Steward · local-first software operator'
const TAG_MID = 'local-first software operator'
const TAG_TINY = 'Steward'
const HIDE_BELOW = 34
  ...
  const heroColumn = wide ? (
    <Box flexDirection="column" width="100%">
      ...
      <Text color={t.color.accent}>
        ...
        <Text color={t.color.muted}> · Steward</Text>
      </Text>
