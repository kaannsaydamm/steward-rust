...
import { ARTIFACTS_ROUTE, BUILDER_ROUTE, contributedRoutes, MESSAGING_ROUTE, ROUTES_AREA, SKILLS_ROUTE } from '../routes'
...
const BUILTIN_PAGES: Record<string, { render: () => ReactNode; title: string }> = {
  ...
  [BUILDER_ROUTE]: { render: () => <BuilderView />, title: 'Agent Builder' }
}
