...
//
// When someone is in a hands-free "Hey Steward" voice chat, the natural way to
...
// phrase (optionally addressed to Steward), so a real turn that merely contains
 ...
 * to Steward). Returns false for anything that merely contains "stop" as part of
