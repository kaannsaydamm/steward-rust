/**
 * Steward Bot Mode — a "one chat per agent" roster for the Steward desktop.
 *
 * Left pane "Bots": one row per Steward profile (a bot = an agent profile) with
 ...
 *
 * Right tile "Routines": scheduled tasks (Steward cron jobs) scoped to the
...
export default {
  ...
  register(ctx: PluginContext) {
    ...
    // A bot's chat before it has spoken: core's splash is Steward' wordmark and
