...
export function displayName(bot: Partial<RosterRow>, meta?: BotMeta | null): string {
  ...
  // "Steward". Annotated active rows carry sourceScoped too, and keying this
  ...
  // never generic "Steward" or a hostname-derived label.
  if (alias) {
  ...
  // that reads like nobody bothered. Present it as Steward (the agent it is)
