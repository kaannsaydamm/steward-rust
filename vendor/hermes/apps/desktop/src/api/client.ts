...
// "Timed out connecting to Steward backend" that hangs the UI (#48504).
//
...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'Steward gateway connection closed',
      connectErrorMessage: 'Could not connect to Steward gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'Steward gateway is not connected',
