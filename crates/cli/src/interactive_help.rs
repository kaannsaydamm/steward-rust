pub fn help_text() -> String {
    [
        ...
        "/cron-create <name> <tool_id> <interval_seconds> [input_json] - schedule a job",
        "/cron-enable <job_id> - enable a cron job",
        "/cron-disable <job_id> - disable a cron job",
        "/cron-delete <job_id> - remove a cron job",
        "/cron-run <job_id> - run a cron job immediately",
