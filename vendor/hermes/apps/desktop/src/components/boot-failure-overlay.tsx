...
export function BootFailureOverlay() {
  ...
  // connection's owning login flow. Steward Cloud must reuse its portal session
  ...
  let hint: string
  // The electron boot path flags a Steward Cloud backend-down (502/503/504) with
  ...
  if (remoteReauth) {
    ...
    // A Steward Cloud agent is down — the user cannot restart the managed
